...
Package.on_use(function (api) {
	api.add_files([
 		...
 		'lib/ace/src/ext-spellcheck.js',
 		'lib/ace/src/mode-scheme.js',
 		...
 		'lib/ace/src/mode-livescript.js',
